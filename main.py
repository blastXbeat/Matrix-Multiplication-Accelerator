...
def main():
    ...
    while True:
        ...
        N = int(input("Enter the size upto which sqr matrix should apply: "))
        ...
        for n in range(1,N+1):
            ...
            for m in method:
                ...
                utils.log_result(method_name , n , elapsed_time , output_dir = f"results/data/{otuput_name}" + f"_{N}.csv")

        # Plotting the results
        utils.plotter( csv_file= f"results/data/{otuput_name}" + f"_{N}.csv" , output_image = f"results/plots/{otuput_name }" + f"_{N}.png")
